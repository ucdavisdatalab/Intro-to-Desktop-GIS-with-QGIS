...
1. Choose a color that you think represents roads well.  I used a dark gray.  You can enter *#666666* into the *HTML notation* box to use the same color if you'd like. Click *Apply* to apply the change. 
...
1. Then click the *=* button below the white dialog box to add an equal sign to the equation.
...
1. Change the *Width* to match the Line Weight (use *points* as the units) in the table below.

Value | Legend | Line Weight (points)
--- | --- | ---
...
Note that points is the unit of measure for the size of a font. You're probably familiar with the size off 12 point font from word processing. It might also be helpful to know that 72 point font is equivalent to one inch high.
